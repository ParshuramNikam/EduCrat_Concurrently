...
const TutorGigpage = () => {
      ...
      axios
        ...
        .then(async (res) => {
          ...
          res.data.user.feedbackInfo.map((feedback) => {
            // console.log(   " || "+ gigId +" || "+ feedback?.gigId)
            if (
              // feedback?.tutorId === appUser._id &&
              gigId === feedback?.gigId && feedback.status === "completed"
  ...
  return (
    <div className="tutor-gig-page" style={{ backgroundColor: "#f5f7fa" }}>
          ...
          <div className="tutor-info">
            ...
            <div className="rating-wrapper">
              <img
                ...
                alt=""
              />
              <div className="rating">{Number.parseInt(ratingCount) > 0 ? Number.parseFloat(Number.parseInt(overallRating) / ratingCount) : 0}</div>
              <div className="rating-no">({ratingCount} Ratings)</div>
            </div>
          </div>
                          ...
                          <div className="gig-commenter-info">
                            <div className="commenter_details">
                              ...
                              <div className="gig-commenter-name">
                                <Link to={"/profile/" + feedback.tuteeId._id}>
                                  {feedback.tuteeId.username} {/* - {feedback.studentRating}⭐ */}
                                </Link>
                              </div>
                            </div>
